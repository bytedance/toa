        ...
        struct request_sock *req, struct dst_entry *dst, struct request_sock *req_unhash, bool *own_req)
{
        ...
        )
    {
        ...
        tcp_ip_display("tcp_v4_syn_recv_sock_toa: outside: ", 0, iph, tcph);
    ...
    if  (entry)
    {
        four_tuple_display("tcp_v4_syn_recv_sock_toa:  inside: ", &entry->value);
        ...
        struct request_sock *req, struct dst_entry *dst, struct request_sock *req_unhash, bool *own_req)
{
        ...
        )
    {
        ...
        tcp_ip_display("tcp_v6_syn_recv_sock_toa: outside: ", 1, ip6h, tcph);
    ...
    if  (entry)
    {
        four_tuple_display("tcp_v6_syn_recv_sock_toa:  inside: ", &entry->value);
